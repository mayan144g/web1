...
if (!_tb_dis) {
    ...
    var _pmpmk = pm_ppy + '/pmk-201827009.4.js';
    var _pmasync = true;
    ...
    'at': '//span[contains(@class, "art_header_footer_author")]/span//font/font | //span[contains(@class, "art_header_footer_author")]/span',
    'sx': '//ul[contains(@class, "trj_trajectory")]//li[1]//a',
    'im': '//div[contains(@class, "ArticleImage")]/img/@src'
};

var _pm_sud = {};

var _tb_vpx = [{
    'xpath': '//div[contains(@class, "video-container")]/iframe',
    'attr': 'iframe'
}];
